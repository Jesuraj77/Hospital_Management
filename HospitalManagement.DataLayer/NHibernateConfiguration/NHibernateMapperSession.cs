...
namespace HospitalManagement.DataLayer.NHibernateConfiguration
{
    public class NHibernateMapperSession : IMapperSession
    {
        ...
        public IQueryable<Patient> patient => _session.Query<Patient>();
        ...
        public async System.Threading.Tasks.Task Save(Patient entity)
        {
            await _session.SaveOrUpdateAsync(entity);
        }

        public async System.Threading.Tasks.Task Delete(Patient entity)
        {
